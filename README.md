...
![App Screenshot](images/yomu_banner.png)
<h2>Plans for the future updates</h2>
<p>This app is meant to be constantly updated adding new lessons. Such as:</p>
<ol>
  <li>Add katakana list;</li>
  <li>Add dakuon, handakuon and yoon for katakana</li>
  <li>Update UI for more appealing look for the app;</li>
  <li>Add complete new lesson like vocabulary that requires completely new method for testing;</li>
  <li>As pointed above completely new method of testing for sentence forming and grammar.</li>
</ol>
